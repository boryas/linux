...
struct cgroup *cgroup_mkdir_kernel_special(struct kernfs_node *parent_kn, const char *name, umode_t mode) { return NULL; }
int cgroup_rmdir_kernel_special(struct kernfs_node *kn) { return 0; }
